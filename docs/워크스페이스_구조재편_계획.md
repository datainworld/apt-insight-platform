...
| **6** | 기존 스크립트 `pipeline/`로 이동 (`git mv`) | ✅ 완료 |
| **7** | `pyproject.toml` 의존성 그룹 분리 | ✅ 완료 |
| **8** | 로컬 폴더명 변경 (`apt-insight-platform`) | ✅ 완료 |
| **9** | GitHub 저장소명 변경 + remote URL 업데이트 | ✅ 완료 |
| **10** | Dokploy 경로 업데이트 | ⏳ 미진행 |
